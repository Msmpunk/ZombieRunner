...
void Game::InitMeshes()
{
	...
	m_zombie.Init("res/Models3D/Zombie2/zom2.obj", m_camera, "res/Shaders/SingleModelLoader.vs", "res/Shaders/SingleModelLoader.fs", false);

	for (auto i = 0; i < 5; ++i)
	{
		// Create mountain rock
		Model mountainRock;
		mountainRock.Init("res/Models3D/ResidentalBuilding/casa1.obj", m_camera, "res/Shaders/SingleModelLoader.vs", "res/Shaders/SingleModelLoader.fs", true);
...
void Game::RenderScene()
{
	...
	m_zombie.Draw(m_camera, glm::vec3(256.0f, m_terrain.GetHeightOfTerrain(300.0f, 350.0f) + 15.0f, 300.0f));
	...
	{
		m_texts[2].SetText("Porcentaje para la extraccion: " + std::to_string((int)m_dataTransmitTimer) + "%");
	}
	else
	{
		m_texts[2].SetSpacing(0.7f);
		m_texts[2].SetText("Extracción Completada");
	}
