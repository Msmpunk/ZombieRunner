...
void Player::Init(Camera& cam, glm::vec3 initialPosition)
{
	...
	m_assaultRifle->Init("res/Models3D/C96/arma3.obj", cam, "res/Shaders/SingleModelLoader.vs", "res/Shaders/SingleModelLoader.fs");
	m_assaultRifle->Configure(35, 0.12f, 1.0f, 35);

	m_sniperRifle = new Weapon();
	m_sniperRifle->Init("res/Models3D/C96/armasniper.obj", cam, "res/Shaders/SingleModelLoader.vs", "res/Shaders/SingleModelLoader.fs");
